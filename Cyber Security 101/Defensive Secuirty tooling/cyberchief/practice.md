...
|Extract URLs|Extracts Uniform Resource Locators (URLs) from the input. The protocol (, , etc.) is required, otherwise there will be far too many false positives.|
...
`Base(64, 85, 58, 62)` are known as **base encodings**.
